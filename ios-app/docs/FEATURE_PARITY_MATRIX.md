...
- Android 自动证据：Flutter analyze 0 error、全量测试 1134/1134；旧 Parity #51 已完成 35 张 Android/iOS 成对截图与完整性对比，1.270.0+284 最终基线需按本次提交重跑；真实 OAuth、provider 网络、IME 和真机仍是用户设备验收项。
