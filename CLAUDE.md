...
- **⚠️ 每次推送前记得**：①水印 +1 ②pubspec version minor+1 且 +N（versionCode）+1（当前 1.9.0+11 / 水印 b0703-15 / DB v18）。APK 下载链接：`.../android-latest/肥喵记账.apk`。
- **智能分类方案进度**：地基(b0703-11)、支付宝退款归零(b0703-13)、AI记账侧增量(b0703-14)、**Phase A 分类大改(b0703-15)** 均已做。**还没做**：①第3层导入复核页(按商户分组批量归类+喂学习)②第4层一次批量AI兜底(去重opt-in)。**缓做**：特殊交易类型 还款/借贷/投资本金 复式记账(太重、和可爱简单路线有张力)。(GPT `记账分类最终版调整建议.md`：医疗/教育补子类、收入细分、居家生活→居家住房、理财→投资收益、新增车辆支出/保险保障一级；新分类用 emoji 图标即"同款"，不用画SVG。**缓做**：特殊交易类型 还款/借贷/投资本金 那套复式记账，太重、和可爱简单路线有张力，现有转账+不计入收支已覆盖80%)。
